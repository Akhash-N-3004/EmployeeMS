...
public class EmployeeControllerTest {
    ...
    void testGetAllEmployees() {
        ...
        employees.add(new Employee(1L, "John", "Doe", 25, "1234567890", "Address 1", "john.doe@example.com", 36, 10, 0, null));
        employees.add(new Employee(2L, "Jane", "Smith", 30, "9876543210", "Address 2", "jane.smith@example.com", 36, 10, 0, null));
    ...
    void testGetEmployeeById_ExistingId() throws ResourceNotFoundException {
        // Arrange
        long id = 1L;
        Employee employee = new Employee(id, "John", "Doe", 25, "1234567890", "Address 1", "john.doe@example.com", 36, 10, 0, null);
    ...
    void testCreateEmployee() {
        // Arrange
        Employee employee = new Employee(null, "John", "Doe", 25, "1234567890", "Address 1", "john.doe@example.com", 36, 10, 0, null);
    ...
    void testUpdateEmployee_ExistingId() throws ResourceNotFoundException {
        // Arrange
        long id = 1L;
        Employee updatedEmployee = new Employee(id, "John", "Doe", 30, "1234567890", "Address 1", "john.doe@example.com", 36, 10, 0, null);
