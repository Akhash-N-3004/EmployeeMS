...
public class JobDepartmentControllerTest {
	  @Mock
	    ...
	    void testUpdateJobDepartment() throws ResourceNotFoundException {
	        ...
	        when(jobDepartmentService.updateJobDepartment(departmentId, updatedJobDepartment)).thenReturn(updatedJobDepartment);

	        // Call the controller method
	        JobDepartment result = jobDepartmentController.updateJobDepartment(departmentId, updatedJobDepartment);

	        // Verify the response
	        assertThat(result).isEqualTo(updatedJobDepartment);
	    }
	    ...
	    void testUpdateJobDepartment_ThrowsResourceNotFoundException() {
	        ...
	        // Call the controller method and verify that it throws ResourceNotFoundException
